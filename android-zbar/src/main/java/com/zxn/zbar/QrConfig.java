...
public class QrConfig implements Serializable {
    ...
    public boolean showInputCode = false;
...
//    public OnInputClickListener mOnInputClickListener;
    ...
    public static class Builder {
        ...
        public Builder setTopText(String text) {
            watcher.topText = text;
            return this;
        }
...
//        public Builder setInputClickListener(OnInputClickListener listener) {
//            watcher.mOnInputClickListener = listener;
//            return this;
//        }
        ...
        public Builder setShowInputCode(boolean show) {
            watcher.showInputCode = show;
            return this;
        }
        ...
        public Builder setShowTopText(boolean show) {
            watcher.showTopText = show;
            return this;
        }
...
//    public OnInputClickListener getOnInputClickListener() {
//        return mOnInputClickListener;
//    }
}
